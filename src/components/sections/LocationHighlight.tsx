              ...
              {locations.map((item, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center group-hover:bg-[#3A4A1F] transition-colors duration-300">
                    <MapPin className="text-[#3A4A1F]/40 w-4 h-4 group-hover:text-white transition-colors duration-300" />
                  </div>
                  <div className="space-y-1.5">
                    <div className="flex flex-wrap items-center gap-2">
                      <h3 className="font-bold text-[#1A1A1A] text-sm leading-none">
                        {item.title}
                      </h3>
              ...
              <div className="relative w-full h-full rounded-[2rem] overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <a
                    ...
                    aria-label="Buka Lodjisvarga di Google Maps"
                    className="w-full bg-[#3A4A1F] text-white px-6 py-4 rounded-xl shadow-xl flex items-center justify-center gap-3 text-xs font-bold hover:bg-[#2D3621] transition-all active:scale-95 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
                  >
                    <Navigation className="w-4 h-4 text-[#D4AF37] group-hover:animate-pulse" aria-hidden="true" />
