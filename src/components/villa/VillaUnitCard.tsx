          ...
          <div className="flex flex-col lg:flex-row lg:min-h-[200px]">
            <div className="relative aspect-[4/3] flex-shrink-0 overflow-hidden lg:aspect-auto lg:w-[280px] xl:w-[300px]">
              <RoomImageCarousel
                ...
                imageClassName="group-hover/img:scale-[1.06]"
                ...
                topBadge={
                  pricing.hasPromo ? (
                    <div className="absolute left-3 top-3 z-20 flex items-center gap-1 rounded-full bg-rose-500 px-2.5 py-1 text-[10px] font-black uppercase tracking-wide text-white shadow-lg">
                      ...
                      {room.activePromo?.discount_code ?? "PROMO"} -{pricing.discountPercentage}%
                    </div>
                  ) : null
                }
              />
              ...
              {highlights.length > 0 ? (
                <div>
                  ...
                  <AmenityChipGroup
                    ...
                    maxVisible={4}
                    showOverflow={false}
                    chipClassName="bg-[#3A4A1F]/6 text-[#3A4A1F] px-3 py-1.5"
                    iconClassName="text-[#3A4A1F]"
                  />
                </div>
              ) : (
                ...
                {isComingSoon ? (
                  ...
                  <>
                    ...
                    {pricing.hasManagedPrice ? (
                      <p
                        className={`mt-0.5 text-[26px] font-black leading-tight tracking-tight ${
                    ...
                    <div className="mt-2 flex flex-wrap gap-1">
                      ...
                      {pricing.hasPromo ? (
                        <span className="rounded-full bg-rose-50 px-2 py-0.5 text-[9px] font-bold uppercase text-rose-600">
                          Hemat {pricing.discountPercentage}%
                        </span>
                      ) : null}
                    </div>
                  </>
