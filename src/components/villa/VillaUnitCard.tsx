        ...
        <div className="flex flex-col justify-end gap-4 bg-slate-50/60 p-5 sm:p-6 lg:w-[240px] lg:flex-shrink-0 xl:w-[256px]">
          <div className="space-y-1.5">
            <InquiryCTA
              ...
              buttonClassName="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#166534] py-3 text-[12px] font-bold text-white shadow-sm transition-colors hover:bg-[#14532D] active:scale-95"
              fallback={
